   ...
   : 메모리 공간에 데이터(값)를 저장할 때 사용된다.
    ...
    변수
      ...
      1. 변수 사용해보기
        ...
        2) 변수에 값을 저장 
          - 변수를 생성한 후 값을 저장하는 것을 할당이라
            부르고 최초에 값을 할당하는 것을 초기화라고
            한다. 
          - 이전 값을 다른 값으로 저장할 수 있는데 이것을
            재할당이라고 부른다.
      ...
      2. var 대신에 let    
        : 변수를 만들 때 사용되는 키워드는 var, let, const가 존재
          한다. 예전에는 var를 사용했지만 여러 문제로 let, const를
          사용할 것을 권장한다.
    ...
    상수
     : 저장한 값을 바꿀 수 없는 공간
      ...
      1. 상수 사용하기
        ...
        3) 상수는 변경될 여지가 없는 값을 저장할 때 사용되므로 
           절대 변경하지 않을 값이나 참조형 데이터를 저장할 때
           사용된다.
  */
...
// [상수 만들기]  
   ...
   const func = function() {console.log(12)};
   const array = ['안녕', 12, true];
   // 상수를 생성함과 동시에 값 저장
