...
/*
      강제 변환!! ->  typeof연산자로 출력해서 확인해보자!
       1) 다른 자료형을 숫자로 강제 변환 => Number()객체
       2) 다른 자료형을 문자열로 강제 변환 => String()객체
       3) 다른 자료형을 불형으로 강제 변환 => Boolean()객체
*/
...
/* 
    ...
    - 자바스크립트에서는 비어있지 않은 문자열은 언제나 'true'이다.
*/
     console.log(Boolean('0'));
...
/*  
       덧셈 단항연산자
        : 피연산자가 숫자가 아닌 다른 자료형일 때 '숫자'로 변환됨
         - 단항 덧셈 연산자(+)는 짧은 문법으로도 Number()와 동일한 일을 할 수 있게 해줍니다.
*/
     let stringNum = '2';
